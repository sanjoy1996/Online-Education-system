...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('teacher.post.update',$post->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                                ...
                                <div class="form-line {{ $errors->has('categories') ? 'focused error' : '' }}">
                                    ...
                                    <select name="category_id" id="category" class="form-control show-tick"  >
                                        @foreach($categories as $category)
                                            <option
                                                value="{{ $category->id }}" @if($category->id==$post->id)  selected @endif>{{ $category->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
